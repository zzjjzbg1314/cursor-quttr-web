...
public class CreatePureMusicRequest {
    ...
    public CreatePureMusicRequest(String image, String audiourl, String videourl, String videourlLd,
                                  ...
                                  String color, Map<String, PureMusicLanguageContentDto> contextText) {
        this.image = image;
