...
public class CreateWhiteNoiseRequest {
    ...
    public CreateWhiteNoiseRequest(String image, String audiourl, String videourl, String videourlLd, String color, Map<String, WhiteNoiseLanguageContentDto> contextText) {
        this.image = image;
