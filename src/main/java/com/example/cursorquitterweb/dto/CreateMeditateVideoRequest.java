 ...
 * 创建冥想视频请求DTO
 */
public class CreateMeditateVideoRequest {
    
    @NotBlank(message = "冥想视频标题不能为空")
    ...
    public CreateMeditateVideoRequest() {}
    
    public CreateMeditateVideoRequest(String title, String subtitle, String image, String videoUrl, 
    ...
    public String toString() {
        return "CreateMeditateVideoRequest{" +
                "title='" + title + '\'' +
                ", subtitle='" + subtitle + '\'' +
                ", image='" + image + '\'' +
                ", videoUrl='" + videoUrl + '\'' +
