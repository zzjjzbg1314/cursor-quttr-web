 ...
 * 更新纯音乐内容请求DTO
 */
public class UpdatePureMusicRequest {
    ...
    public UpdatePureMusicRequest() {
    }

    public UpdatePureMusicRequest(String image, String audiourl, String videourl, String videourlLd, String color, Map<String, PureMusicLanguageContentDto> contextText) {
        this.image = image;
