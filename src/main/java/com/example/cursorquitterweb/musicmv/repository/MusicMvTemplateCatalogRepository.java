...
public class MusicMvTemplateCatalogRepository {
    ...
    public List<Map<String, Object>> templates(String locale, String status, String visibility,
        ...
        sql.append("SELECT t.template_id, t.capcut_template_id, t.slug, t.category_key, t.tags_json, t.status, ")
                ...
                .append("CASE WHEN json_extract(runtime_scene.scene_json, '$.runtimeDelivery.schemaVersion')='browser-runtime-delivery-v1' ")
                .append("THEN json_extract(runtime_scene.scene_json, '$.runtimeDelivery.totalSizeBytes') END AS runtime_package_size_bytes, ")
                ...
                .append("LEFT JOIN template_browser_scenes runtime_scene ON runtime_scene.version_id=t.current_version_id ")
