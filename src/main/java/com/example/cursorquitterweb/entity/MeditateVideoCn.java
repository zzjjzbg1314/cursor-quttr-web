...
/**
 * 冥想视频实体类（中文版）
 * 对应数据库表: meditate_video_cn
 * 已移除 JPA 注解，现在作为普通 POJO 使用
 * 注意：meditateQuotes 字段需要手动处理关联表 meditate_video_quotes_cn
 */
public class MeditateVideoCn {
    ...
    /**
     * 冥想语录列表
     * 注意：需要手动处理关联表 meditate_video_quotes_cn
     */
