...
public class PrivacyController {
    ...
    private String buildPrivacyContent() {
        ...
        content.append("1. 开发者信息\n");
        content.append("开发者名称：上海比特星瀚科技有限公司\n\n");

        content.append("2. 我们收集的信息\n");
        ...
        content.append("5. 数据安全\n");
        content.append("我们采取多种安全措施，包括数据传输与存储加密，防止未经授权的访问、篡改、披露或销毁。\n\n");
        
        content.append("6. 数据保留\n");
        content.append("我们会在你的账号存在期间保留信息。若你希望删除账号，可在应用内直接操作，");
        content.append("或联系 415730931@qq.com。账号删除后，你的个人数据将从服务器永久移除。\n\n");
        
        content.append("7. 你的权利\n");
        content.append("你有权：\n");
